  ...
  describe("11 - Exibe nomes de musicas em sua forma normal e com string trocada", () => {
    it("Verifica o desafio 11", async () => {
      ...
      const expectedResult = [
        ...
        {
          nome_musica: "Troubles Of My Inner Fire",
          novo_nome: "Troubles Of My Project",
        },
        {
          nome_musica: "Without My Streets",
          novo_nome: "Without My Code Review",
        },
      ];
